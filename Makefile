...
build.stamp: venv source/config.yaml $(SOURCES)
	...
	. venv/bin/activate; pyftsubset fonts/variable/ChironHeiHK[wght].ttf --glyphs-file=source/Regular/subset_roman.txt --no-layout-closure --notdef-glyph --glyph-names --name-IDs=* --notdef-outline --output-file=fonts/variable/ChironHeiHK[wght].ttf
	. venv/bin/activate; pyftsubset fonts/variable/ChironHeiHK-Italic[wght].ttf --glyphs-file=source/Italic/subset_italic.txt --no-layout-closure --notdef-glyph --glyph-names --name-IDs=* --notdef-outline --output-file=fonts/variable/ChironHeiHK-Italic[wght].ttf
